...
public class PaieUtilsTest {
	...
	@Test
	public void test_formaterBigDecimal_trois_chiffres_apres_la_virgule_v02() {
	String resultat = paieUtils.formaterBigDecimal(new BigDecimal("5.259"));
	assertThat(resultat, equalTo("5.26"));
	}
